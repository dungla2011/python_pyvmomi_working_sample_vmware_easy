...
class Statistics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.domains.intrusion_service_policies.statistics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _StatisticsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/domains/{domain-id}/intrusion-service-policies/{ids-policy-id}/statistics',
            path_variables={
                'domain_id': 'domain-id',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.domains.intrusion_service_policies.statistics',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'rules': 'com.vmware.nsx_policy.global_infra.domains.intrusion_service_policies.rules_client.StubFactory',
    }
