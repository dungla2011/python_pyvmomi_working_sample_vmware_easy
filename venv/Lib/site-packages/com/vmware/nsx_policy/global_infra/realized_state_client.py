...
class SystemVirtualMachines(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.realized_state.system_virtual_machines'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _SystemVirtualMachinesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/system-virtual-machines',
            path_variables={
            },
            query_parameters={
                'cursor': 'cursor',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.realized_state.system_virtual_machines',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
