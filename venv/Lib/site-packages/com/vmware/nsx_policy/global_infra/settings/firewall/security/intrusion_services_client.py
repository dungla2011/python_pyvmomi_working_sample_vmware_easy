...
class GlobalSignatures(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Stats(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.stats'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _GlobalSignaturesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/global-infra/settings/firewall/security/intrusion-services/global-signatures/{signature-id}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/settings/firewall/security/intrusion-services/global-signatures',
            path_variables={
            },
            query_parameters={
                'cursor': 'cursor',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _StatsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        reset_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/global-infra/settings/firewall/security/intrusion-services/stats?action=reset',
            path_variables={
            },
            query_parameters={
                'category': 'category',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.stats',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
