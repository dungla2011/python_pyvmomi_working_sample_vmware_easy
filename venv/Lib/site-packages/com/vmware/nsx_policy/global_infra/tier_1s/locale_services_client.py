...
class ByodServiceInstances(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_1s.locale_services.byod_service_instances'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Multicast(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_1s.locale_services.multicast'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _ByodServiceInstancesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/global-infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/byod-service-instances/{service-instance-id}',
            path_variables={
                'tier1_id': 'tier-1-id',
                'locale_service_id': 'locale-service-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-1s/{tier-1-id}/locale-services/{locale-service-id}/byod-service-instances',
            path_variables={
                'tier1_id': 'tier-1-id',
                'locale_service_id': 'locale-service-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_1s.locale_services.byod_service_instances',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _MulticastStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-1s/{tier-1-id}/locale-services/{locale-services-id}/multicast',
            path_variables={
                'tier1_id': 'tier-1-id',
                'locale_services_id': 'locale-services-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_1s.locale_services.multicast',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'byod_service_instances': 'com.vmware.nsx_policy.global_infra.tier_1s.locale_services.byod_service_instances_client.StubFactory',
        'endpoints': 'com.vmware.nsx_policy.global_infra.tier_1s.locale_services.endpoints_client.StubFactory',
        ...
        'multicast': 'com.vmware.nsx_policy.global_infra.tier_1s.locale_services.multicast_client.StubFactory',
