...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.firewall_identity_stores.
#---------------------------------------------------------------------------
...
class Groups(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.firewall_identity_stores.groups'
    """
...
class LdapServers(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.firewall_identity_stores.ldap_servers'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class SyncStats(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.firewall_identity_stores.sync_stats'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _GroupsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/firewall-identity-stores/{firewall-identity-store-id}/groups',
            path_variables={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.firewall_identity_stores.groups',
...
class _LdapServersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/global-infra/firewall-identity-stores/{firewall-identity-store-id}/ldap-servers/{ldap-server-id}',
            path_variables={
                'firewall_identity_store_id': 'firewall-identity-store-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/firewall-identity-stores/{firewall-identity-store-id}/ldap-servers',
            path_variables={
                'firewall_identity_store_id': 'firewall-identity-store-id',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.firewall_identity_stores.ldap_servers',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class _SyncStatsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/firewall-identity-stores/{firewall-identity-store-id}/sync-stats',
            path_variables={
                'firewall_identity_store_id': 'firewall-identity-store-id',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.firewall_identity_stores.sync_stats',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'SyncStats': SyncStats,
        'groups': 'com.vmware.nsx_policy.global_infra.firewall_identity_stores.groups_client.StubFactory',
    }
