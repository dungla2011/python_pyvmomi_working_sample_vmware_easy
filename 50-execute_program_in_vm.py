...
def main():
    ...
    try:
        ...
        if 1:
            # vm_name = "xxx win2016-test1_2021-08-03_ip-163.216." + str(i)
            ...
            try:
                ...
                program_arguments = "interface ipv4 set address name=\"Ethernet0\" static 10.0.0.111 255.255.255.0 10.0.0.1"

                path_to_program = "C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe"
                program_arguments = "Enable-NetAdapterBinding -Name \"*\" -ComponentID ms_tcpip6"
