...
def get_args():
    ...
    vCenter server function taken from 12-getallvms.py script
...
def getvm_info(vm, depth=1):
    ...
    from the 12-getallvms.py script from pyvmomi from github repo
    """
    maxdepth = 10
...
def main():
    ...
    are taken from the 12-getallvms.py script from the pyvmomi gihub repo
    """
    parser = cli.Parser()
